...
Risks
-------------
Running a webbrowser on the same node with a REST enabled lunariumd can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:1234/tx/json/1234567890">` which might break the nodes privacy.
