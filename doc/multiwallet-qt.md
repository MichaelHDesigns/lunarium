...
In order to support loading of multiple wallets in lunarium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lunarium.cpp.
...
Changes to lunarium.cpp
----------------------
lunarium.cpp is the entry point into lunarium-qt, and as such, will require some minor modifications to provide hooks for
