...
4.  (Optional) You can also install lunariumd to your path:
...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure Lunarium with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the Lunarium wallet:
...
You have the choice to build the GUI Lunarium wallet as a Mac OSX app, described in “How to build the Lunarium-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the Lunarium-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find Lunarium-Qt.dmg inside your Lunarium folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/Lunarium/src/qt/lunarium-qt