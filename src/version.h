...
#ifndef LUNARIUM_VERSION_H
#define LUNARIUM_VERSION_H
...
static const int MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT = 70016;

static const int MIN_PEER_VERSION_FIXED_SIGTIME = 70009;

//! soft fork block
static const int SOFT_FORK_BLOCK = 400000;
