...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXLN"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Lunarium help message to get a list with possible Lunarium command-line options"));
