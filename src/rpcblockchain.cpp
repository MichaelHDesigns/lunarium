...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.push_back(Pair("zXLNsupply", zphrObj));
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zXLNsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zXLN denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zXLN denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zXLN denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zXLN denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zXLN denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zXLN denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zXLN denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zXLN denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zXLN denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"value\" : x.xxx,           (numeric) The transaction value in lunarium\n"
