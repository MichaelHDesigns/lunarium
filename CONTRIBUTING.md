...
The Lunarium project operates an open contributor model where anyone is
...
The following applies to code changes to the Lunarium project, and is not to be
confused with overall Lunarium Network Protocol consensus changes.

Whether a pull request is merged into Lunarium rests with the project merge
...
Patches that change Lunarium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lunarium consensus, it must have been
...
The project leader is the release manager for each Lunarium release.
